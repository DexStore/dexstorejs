...
import {ChainConfig} from "dexstorejs-ws";
...
var test = function(key) {
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("Create DST short address", function() {
            ...
            it("DST public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    // delegate0
    // sourced from: ./dexstore/programs/utils/dst_create_key
    ...
    // https://github.com/DexStore/dexstore/blob/2602504998dcd63788e106260895769697f62b07/libraries/wallet/wallet_db.cpp#L103-L108
